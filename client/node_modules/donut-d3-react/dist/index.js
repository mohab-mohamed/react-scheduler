...
var Donut = function (_Component) {
  ...
  function Donut(props) {
    ...
    _this.renderArc = function (d, i, radius, total) {
      return React__default.createElement(Arc, { key: i,
        outerRadius: radius,
    ...
    _this.donut = React__default.createRef();
    return _this;
  }
  ...
  createClass(Donut, [{
    ...
    value: function renderKey(d, i, total) {
      return React__default.createElement(
        ...
        React__default.createElement('rect', { className: 'key', fill: this.props.colorScale(i), x: '0', y: '0', width: this.props.keyRectSize, height: this.props.keyRectSize }),
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        showKey ? React__default.createElement(
          'svg',
...
var Arc = function (_Component2) {
  ...
  createClass(Arc, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(
        'path',
        { className: 'arc', d: arc(d), fill: fill, onClick: function onClick(e) {
